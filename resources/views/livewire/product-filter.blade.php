<div>
    ...
    <section class="{{ count($products) > 2 ? 'grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8' : 'grid grid-cols-1 md:grid-cols-2 gap-8 justify-center' }}">
            ...
            <div class="w-full max-w-sm bg-white border border-gray-200 rounded-lg shadow">
                ...
                <div class="px-5 pb-5">
                    ...
                    <div class="flex items-center justify-between">
                        ...
                        @endif
                        <a  href="{{route('product_show',['slug' => $product->slug])}}"  class="text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center">Examinar</a>
                    </div>
                </div>
            </div>
        @endforeach
